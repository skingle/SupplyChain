...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        var eventDebug = supplyChain.debug();
        await eventDebug.watch((err, res) => {
           console.log(res);
        })
        // Mark an item as Sold by calling function buyItem()
        await supplyChain.buyItem(upc,{from:distributorID,value:20200,gasPrice:0});
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        //consumerRole.addConsumer(consumerID);
        //farmerRole.addFarmer(originFarmerID);
        //distributorRole.addDistributor(distributorID);
        retailerRole.addRetailer(accounts[3]);
        // Declare and Initialize a variable for event
        var eventEmitted = false
        ...
        var eventDebug = retailerRole.debug();
        await eventDebug.watch((err, res) => {
           console.log(res);
        })
        // Mark an item as Received by calling function receiveItem()
        await supplyChain.receiveItem(upc,{from:accounts[0]});
